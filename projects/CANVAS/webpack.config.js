...
module.exports = function (env, argv) {
    return {
        ...
        output: {
            ...
            filename:
                argv.mode === "development" ? "[name].js" : "[name].min.js",
            publicPath: "",
        },
        resolve: resolve,
        module: {
                        ...
                        (compilation) => {
                            ...
                            if (compilation.warnings.length > 0) {
                                ...
                                notifier.notify({
                                    title: title,
                                    message:
                                        "Check out your command-line for more info about this warning!",
                                    icon: "D:\\warning.png",
                                });
                            ...
                            if (compilation.errors.length > 0) {
                                ...
                                notifier.notify({
                                    title: title,
                                    message:
                                        "Check out your command-line for more info about this error!",
                                    icon: "D:\\warning.png",
                                });
                            ...
                            console.log();
                            console.log(
                                `[${new Date().toLocaleString()}] Compile: ${warningCount} warning, ${errorCount} error`
                            );
                            console.log(
                                "=========================================================="
                            );
        ...
        devServer: {
            ...
            after(app, server) {
                ...
                console.log("|");
                console.log(
                    "| Mode: \x1b[36m%s\x1b[0m",
                    argv.mode.charAt(0).toUpperCase() + argv.mode.slice(1)
                );
                console.log(
                    "================================================================"
                );
